...
function Footer() {
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-.1" className='flex gap5 w-full h-screen bg-zinc-900 p-20 font-mono'>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className='heading'>
                    <h1 className='text-[8vw] font-semibold uppercase leading-none tracking-tighter'>Eye-</h1>
                    <h1 className='text-[8vw] font-semibold uppercase leading-none tracking-tighter'>Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[8vw] -ms-20 font-semibold uppercase leading-none tracking-tighter'>
                    Presentations
                </h1>
                <div className='dets'>
